...
class SuratInaportnetsDataTable extends DataTable
{
    /**
     ...
     */
    public function query(SuratInaportnet $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('suratinaportnets-table')
    ...
    {
        return 'SuratInaportnets_' . date('YmdHis');
    }
}