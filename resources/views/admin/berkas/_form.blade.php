...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" placeholder="File..." type="file" name="file_berkas" @if(!isset($berkas)) required @endif accept="application/pdf,image/*"/>
            @if (@$berkas->file_berkas != null)
                <a href="{{ url($berkas->file_berkas) }}" target="_blank" class="btn btn-info btn-sm m-1"
