...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/mazer/compiled/css/app.css') }}" />
...
<body>
    <script src="{{ url('mazer/static/js/initTheme.js') }}"></script>
    <div id="app">
        ...
        <div id="main" class="layout-navbar navbar-fixed">
                            ...
                            <ul class="navbar-nav ms-auto mb-lg-0">
                                ...
                                <li class="nav-item dropdown me-3">
                                    <a class="nav-link active dropdown-toggle text-gray-600" href="#"
                                        ...
                                        <span
                                            class="badge badge-notification bg-danger">0</span>
                                    </a>
            ...
            <div id="main-content">
                ...
                @include('admin.layouts._partials.alert')
    ...
    <script src="{{ url('mazer/static/js/components/dark.js') }}"></script>
    <script src="{{ url('mazer/extensions/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
