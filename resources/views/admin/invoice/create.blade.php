            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="card-header-action">
                        <a href="{{ route('admin.invoice.index') }}" class="btn btn-warning btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.invoice.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <a href="{{ route('admin.invoice.index') }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-left"></i> Batal</a>
                        </div>
                    </form>
                </div>
            </div>
