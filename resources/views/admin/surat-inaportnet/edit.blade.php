...
@section('heading')
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Ubah Data Surat Permohonan Inaportnet</h3>
            <p class="text-subtitle text-muted">
                Ubah data surat-inaportnet
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        Ubah Data Surat Permohonan Inaportnet
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="col-md-12">
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.surat-inaportnet.update',$surat->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
