...
@section('heading')
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Data Stuktur Organisasi</h3>
            <p class="text-subtitle text-muted">
                List data Stuktur Organisasi yang mengelola website.
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#"> Stuktur Organisasi</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        Data Stuktur Organisasi
                    </li>
                </ol>
            </nav>
        </div>
...
@section('content')
    <form action="{{ route('admin.konten.struktur-organisasi.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <section class="section">
                    <div class="card">
                        <div class="card-header ">
                            <h4 class="card-title">Data Stuktur Organisasi</h4>
                            <ul>
                                <li>Drag & Drop node ke posisi yang di inginkan</li>
                                <li>Untuk menambah node, arahkan mouse ke atas node sehingga akan muncul tombol dengan ikon "+"</li>
                                <li>Untuk menghapus node, arahkan mouse ke atas node dan klik kanan untuk memunculkan menu "Remove"</li>
                                <li>Unutk mengubah detail node, pilih node dan klik node tersebut sehingga akan memunculkan menu "Edit Details" di bagian bawah peta node</li>
                            </ul>
                        </div>
                        <div class="card-body table-responsive">
                            <div id="myDiagramDiv"
                                ...
                                <canvas tabindex="0" width="1054" height="551"
                                    style="position: absolute; top: 0px; left: 0px; z-index: 2; user-select: none; touch-action: none; width: 1054px; height: 551px; cursor: auto;"></canvas>
                                <div style="position: absolute; overflow: auto; width: 1054px; height: 568px; z-index: 1;">
                                    <div style="position: absolute; width: 1205.43px; height: 1px;"></div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            ...
                            <div class="form-group">
                                <label for="mySavedModel">Data Json</label>
                                <textarea id="mySavedModel" name="struktur_organisasi" rows="10" class="form-control">
{!! $strukturJson !!}
                                </textarea>
                            </div>
                        </div>
...
@push('styles')
    <link rel="stylesheet" href="https://unpkg.com/gojs@2.3.10/extensions/DataInspector.css">
@endpush
...
@push('scripts')
    ...
    <script src="https://unpkg.com/gojs@2.3.10/extensions/DataInspector.js"></script>
    <script id="code">
        function init() {
